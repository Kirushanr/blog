...
Please do not create privileged long-lived credentials that gives access to your Cloud environment (e.g. AWS Access Keys) or Code repositories. Always use ephemeral credentials where possible. This gives attackers a small time window to act.
